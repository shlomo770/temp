...
import { parseEntityFormCategory } from "../../enums/entityCategory.enum";

export type EntityDuplicateDialogProps = {
  duplicateName: string;
  duplicateCategory: EntityFormCategory;
  onDuplicateNameChange: (v: string) => void;
  onDuplicateCategoryChange: (v: EntityFormCategory) => void;
  onCancel: () => void;
  onSave: () => void;
};
  ...
  <div className="fixed left-[340px] top-24 z-[1000] w-[330px] rounded border border-gray-700/70 bg-[#1f2937] p-5 shadow-lg">
    ...
    <div className="mb-4">
      ...
      <select
        ...
        onChange={(e) => onDuplicateCategoryChange(parseEntityFormCategory(e.target.value))}
        className="input-dark w-full"
      >
