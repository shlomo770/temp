/**
 * אייקוני נקודה (marker) – Segoe MDL2 Assets / Segoe Fluent Icons
 * קוד Unicode hex להצגה עם font-family: 'Segoe MDL2 Assets' או 'Segoe Fluent Icons'
 */
...
/** מחזיר את תו ה-Unicode מקוד hex (למשל 'E7BA' -> '\uE7BA') */
...
/**
 * יוצר תמונת אייקון למיפוי (canvas עם גופן Segoe) – להצגה כ-icon-image בשכבת symbol
 */
