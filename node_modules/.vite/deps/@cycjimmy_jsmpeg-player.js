...
// node_modules/@cycjimmy/jsmpeg-player/dist/jsmpeg-player.esm.js
function _extends() {
...
var VideoElement = function() {
  function VideoElement2(wrapper, videoUrl, _temp, overlayOptions) {
    var _ref = _temp === void 0 ? {} : _temp, _ref$canvas = _ref.canvas, canvas = _ref$canvas === void 0 ? "" : _ref$canvas, _ref$poster = _ref.poster, poster = _ref$poster === void 0 ? "" : _ref$poster, _ref$autoplay = _ref.autoplay, autoplay = _ref$autoplay === void 0 ? false : _ref$autoplay, _ref$autoSetWrapperSi = _ref.autoSetWrapperSize, autoSetWrapperSize = _ref$autoSetWrapperSi === void 0 ? false : _ref$autoSetWrapperSi, _ref$loop = _ref.loop, loop = _ref$loop === void 0 ? false : _ref$loop, _ref$control = _ref.control, control = _ref$control === void 0 ? true : _ref$control, _ref$decodeFirstFrame = _ref.decodeFirstFrame, decodeFirstFrame = _ref$decodeFirstFrame === void 0 ? true : _ref$decodeFirstFrame, _ref$picMode = _ref.picMode, picMode = _ref$picMode === void 0 ? false : _ref$picMode, _ref$progressive = _ref.progressive, progressive = _ref$progressive === void 0 ? true : _ref$progressive, _ref$chunkSize = _ref.chunkSize, chunkSize = _ref$chunkSize === void 0 ? 1024 * 1024 : _ref$chunkSize, _ref$hooks = _ref.hooks, hooks = _ref$hooks === void 0 ? {} : _ref$hooks;
  ...
  var _proto = VideoElement2.prototype;
...
var CreateVideoElements = function CreateVideoElements2() {
  var elements = document.querySelectorAll(".jsmpeg");
  for (var i = 0; i < elements.length; i++) {
    new VideoElement(elements[i]);
  }
};
var Fill = function Fill2(array, value) {
  if (array.fill) {
    array.fill(value);
  } else {
...
var Base64ToArrayBuffer = function Base64ToArrayBuffer2(base64) {
...
var AjaxSource = function() {
  function AjaxSource2(url, options) {
    this.url = url;
  ...
  var _proto = AjaxSource2.prototype;
...
var AjaxProgressiveSource = function() {
  function AjaxProgressiveSource2(url, options) {
    this.url = url;
    this.destination = null;
    this.request = null;
    this.streaming = false;
  ...
  var _proto = AjaxProgressiveSource2.prototype;
  _proto.connect = function connect(destination) {
    this.destination = destination;
  };
  _proto.start = function start() {
  ...
  return AjaxProgressiveSource2;
}();
var WSSource = function() {
  function WSSource2(url, options) {
    this.url = url;
    ...
    this.destination = null;
    this.reconnectInterval = options.reconnectInterval !== void 0 ? options.reconnectInterval : 5;
  ...
  var _proto = WSSource2.prototype;
  _proto.connect = function connect(destination) {
    this.destination = destination;
  };
  _proto.destroy = function destroy() {
...
var BitBuffer = function() {
  function BitBuffer2(bufferOrLength, mode) {
  ...
  var _proto = BitBuffer2.prototype;
  ...
  _proto.peek = function peek(count) {
    ...
    while (count) {
      ...
      var remaining = 8 - (offset & 7);
      var read = remaining < count ? remaining : count;
...
var BaseDecoder = function() {
  ...
  var _proto = BaseDecoder2.prototype;
  _proto.destroy = function destroy() {
  };
  _proto.connect = function connect(destination) {
    this.destination = destination;
...
var MPEG1 = function(_BaseDecoder) {
  function MPEG12(options) {
    var _this;
  ...
  _inheritsLoose(MPEG12, _BaseDecoder);
  var _proto = MPEG12.prototype;
  _proto.write = function write(pts, buffers) {
    BaseDecoder.prototype.write.call(this, pts, buffers);
    if (!this.hasSequenceHeader) {
      if (this.bits.findStartCode(MPEG12.START.SEQUENCE) === -1) {
        return false;
      }
  ...
  _proto.decode = function decode() {
    ...
    if (this.bits.findStartCode(MPEG12.START.PICTURE) === -1) {
      return false;
    }
    this.decodePicture();
  ...
  _proto.decodeSequenceHeader = function decodeSequenceHeader() {
    ...
    this.bits.skip(4);
    this.frameRate = MPEG12.PICTURE_RATE[this.bits.read(4)];
    ...
    if (this.bits.read(1)) {
      for (var i = 0; i < 64; i++) {
        this.customIntraQuantMatrix[MPEG12.ZIG_ZAG[i]] = this.bits.read(8);
      }
      this.intraQuantMatrix = this.customIntraQuantMatrix;
    }
    if (this.bits.read(1)) {
      for (var _i = 0; _i < 64; _i++) {
        var idx = MPEG12.ZIG_ZAG[_i];
  ...
  _proto.initBuffers = function initBuffers() {
    this.intraQuantMatrix = MPEG12.DEFAULT_INTRA_QUANT_MATRIX;
    this.nonIntraQuantMatrix = MPEG12.DEFAULT_NON_INTRA_QUANT_MATRIX;
  ...
  _proto.decodePicture = function decodePicture() {
    ...
    this.bits.skip(16);
    if (this.pictureType <= 0 || this.pictureType >= MPEG12.PICTURE_TYPE.B) {
      return;
    }
    if (this.pictureType === MPEG12.PICTURE_TYPE.PREDICTIVE) {
    ...
    } while (code === MPEG12.START.EXTENSION || code === MPEG12.START.USER_DATA);
    while (code >= MPEG12.START.SLICE_FIRST && code <= MPEG12.START.SLICE_LAST) {
    ...
    if (this.pictureType === MPEG12.PICTURE_TYPE.INTRA || this.pictureType === MPEG12.PICTURE_TYPE.PREDICTIVE) {
  ...
  _proto.decodeMacroblock = function decodeMacroblock() {
    var increment = 0;
    var t = this.readHuffman(MPEG12.MACROBLOCK_ADDRESS_INCREMENT);
    while (t === 34) {
      t = this.readHuffman(MPEG12.MACROBLOCK_ADDRESS_INCREMENT);
    }
    while (t === 35) {
      increment += 33;
      t = this.readHuffman(MPEG12.MACROBLOCK_ADDRESS_INCREMENT);
    ...
    this.mbRow = this.macroblockAddress / this.mbWidth | 0;
    this.mbCol = this.macroblockAddress % this.mbWidth;
    var mbTable = MPEG12.MACROBLOCK_TYPE[this.pictureType];
    ...
    var cbp = (this.macroblockType & 2) !== 0 ? this.readHuffman(MPEG12.CODE_BLOCK_PATTERN) : this.macroblockIntra ? 63 : 0;
  ...
  _proto.decodeMotionVectors = function decodeMotionVectors() {
    ...
    if (this.macroblockMotFw) {
      code = this.readHuffman(MPEG12.MOTION);
    ...
    } else if (this.pictureType === MPEG12.PICTURE_TYPE.PREDICTIVE) {
      this.motionFwH = this.motionFwHPrev = 0;
      this.motionFwV = this.motionFwVPrev = 0;
    }
  };
  ...
  _proto.decodeBlock = function decodeBlock(block) {
    ...
    if (this.macroblockIntra) {
      ...
      if (block < 4) {
        ...
        dctSize = this.readHuffman(MPEG12.DCT_DC_SIZE_LUMINANCE);
      } else {
        predictor = block === 4 ? this.dcPredictorCr : this.dcPredictorCb;
        dctSize = this.readHuffman(MPEG12.DCT_DC_SIZE_CHROMINANCE);
      }
      if (dctSize > 0) {
    ...
    while (true) {
      var run = 0;
      var coeff = this.readHuffman(MPEG12.DCT_COEFF);
      ...
      n += run;
      var dezigZagged = MPEG12.ZIG_ZAG[n];
      n++;
      level <<= 1;
      if (!this.macroblockIntra) {
        level += level < 0 ? -1 : 1;
      ...
      this.blockData[dezigZagged] = level * MPEG12.PREMULTIPLIER_MATRIX[dezigZagged];
    }
    var destArray;
    var destIndex;
    var scan;
    ...
    if (this.macroblockIntra) {
      if (n === 1) {
        MPEG12.CopyValueToDestination(this.blockData[0] + 128 >> 8, destArray, destIndex, scan);
        this.blockData[0] = 0;
      } else {
        MPEG12.IDCT(this.blockData);
        MPEG12.CopyBlockToDestination(this.blockData, destArray, destIndex, scan);
        Fill(this.blockData, 0);
      }
    } else {
      if (n === 1) {
        MPEG12.AddValueToDestination(this.blockData[0] + 128 >> 8, destArray, destIndex, scan);
        this.blockData[0] = 0;
      } else {
        MPEG12.IDCT(this.blockData);
        MPEG12.AddBlockToDestination(this.blockData, destArray, destIndex, scan);
        Fill(this.blockData, 0);
      }
    }
    n = 0;
  };
  MPEG12.CopyBlockToDestination = function CopyBlockToDestination(block, dest, index, scan) {
  ...
  MPEG12.AddBlockToDestination = function AddBlockToDestination(block, dest, index, scan) {
    for (var n = 0; n < 64; n += 8, index += scan + 8) {
      dest[index + 0] += block[n + 0];
      dest[index + 1] += block[n + 1];
      dest[index + 2] += block[n + 2];
  ...
  MPEG12.CopyValueToDestination = function CopyValueToDestination(value, dest, index, scan) {
    for (var n = 0; n < 64; n += 8, index += scan + 8) {
      dest[index + 0] = value;
      dest[index + 1] = value;
      dest[index + 2] = value;
  ...
  MPEG12.AddValueToDestination = function AddValueToDestination(value, dest, index, scan) {
    for (var n = 0; n < 64; n += 8, index += scan + 8) {
      dest[index + 0] += value;
      dest[index + 1] += value;
      dest[index + 2] += value;
  ...
  MPEG12.IDCT = function IDCT(block) {
    var b1;
    var b3;
    var b4;
    var b6;
...
var MPEG1WASM = function(_BaseDecoder) {
  function MPEG1WASM2(options) {
    var _this;
    _this = _BaseDecoder.call(this, options) || this;
    _this.onDecodeCallback = options.onVideoDecode;
  ...
  _inheritsLoose(MPEG1WASM2, _BaseDecoder);
  var _proto = MPEG1WASM2.prototype;
...
var MP2 = function(_BaseDecoder) {
  function MP22(options) {
    var _this;
    _this = _BaseDecoder.call(this, options) || this;
    ...
    _this.D.set(MP22.SYNTHESIS_WINDOW, 0);
    _this.D.set(MP22.SYNTHESIS_WINDOW, 512);
  ...
  _inheritsLoose(MP22, _BaseDecoder);
  var _proto = MP22.prototype;
  _proto.decode = function decode() {
    var startTime = Now();
  ...
  _proto.decodeFrame = function decodeFrame(left, right) {
    ...
    if (sync !== MP22.FRAME_SYNC || version !== MP22.VERSION.MPEG_1 || layer !== MP22.LAYER.II) {
      return 0;
    }
    ...
    var sampleRate = MP22.SAMPLE_RATE[sampleRateIndex];
    if (sampleRateIndex === 3) {
      return 0;
    }
    if (version === MP22.VERSION.MPEG_2) {
      sampleRateIndex += 4;
      bitrateIndex += 14;
    }
    ...
    var bound = 0;
    if (mode === MP22.MODE.JOINT_STEREO) {
      bound = this.bits.read(2) + 1 << 2;
    } else {
      this.bits.skip(2);
      bound = mode === MP22.MODE.MONO ? 0 : 32;
    }
    this.bits.skip(4);
    if (hasCRC) {
      this.bits.skip(16);
    }
    var bitrate = MP22.BIT_RATE[bitrateIndex];
    sampleRate = MP22.SAMPLE_RATE[sampleRateIndex];
    var frameSize = 144e3 * bitrate / sampleRate + padding | 0;
    var tab3 = 0;
    var sblimit = 0;
    if (version === MP22.VERSION.MPEG_2) {
      tab3 = 2;
      ...
      var tab1 = mode === MP22.MODE.MONO ? 0 : 1;
      var tab2 = MP22.QUANT_LUT_STEP_1[tab1][bitrateIndex];
      tab3 = MP22.QUANT_LUT_STEP_2[tab2][sampleRateIndex];
      sblimit = tab3 & 63;
      tab3 >>= 6;
    }
    if (bound > sblimit) {
    ...
    var channels = mode === MP22.MODE.MONO ? 1 : 2;
      ...
      for (var granule = 0; granule < 4; granule++) {
        ...
        for (var p = 0; p < 3; p++) {
          ...
          for (var _ch2 = 0; _ch2 < 2; _ch2++) {
            MP22.MatrixTransform(this.sample[_ch2], p, this.V[_ch2], this.VPos);
            Fill(this.U, 0);
  ...
  _proto.readAllocation = function readAllocation(sb, tab3) {
    var tab4 = MP22.QUANT_LUT_STEP_3[tab3][sb];
    var qtab = MP22.QUANT_LUT_STEP4[tab4 & 15][this.bits.read(tab4 >> 4)];
    return qtab ? MP22.QUANT_TAB[qtab - 1] : 0;
  };
  _proto.readSamples = function readSamples(ch, sb, part) {
    ...
    if (sf === 63) {
      ...
      var shift = sf / 3 | 0;
      sf = MP22.SCALEFACTOR_BASE[sf % 3] + (1 << shift >> 1) >> shift;
    }
    var adj = q.levels;
    if (q.group) {
  ...
  MP22.MatrixTransform = function MatrixTransform(s, ss, d, dp) {
    var t01;
    var t02;
    var t03;
    var t04;
...
MP2.QUANT_TAB = {
  ...
  D: 12
  // Table 3-B.2d:  low-rate, sblimit = 12
};
...
var MP2WASM = function(_BaseDecoder) {
  function MP2WASM2(options) {
    var _this;
    _this = _BaseDecoder.call(this, options) || this;
    _this.onDecodeCallback = options.onAudioDecode;
    _this.module = options.wasmModule;
  ...
  _inheritsLoose(MP2WASM2, _BaseDecoder);
  var _proto = MP2WASM2.prototype;
  _proto.initializeWasmDecoder = function initializeWasmDecoder() {
    if (!this.module.instance) {
      console.warn("JSMpeg: WASM module not compiled yet");
      return;
  ...
  _proto.decode = function decode() {
    ...
    if (this.destination) {
      ...
      var left = this.instance.heapF32.subarray(leftOffset, leftOffset + MP2WASM2.SAMPLES_PER_FRAME);
      var right = this.instance.heapF32.subarray(rightOffset, rightOffset + MP2WASM2.SAMPLES_PER_FRAME);
      this.destination.play(this.sampleRate, left, right);
    }
    this.advanceDecodedTime(MP2WASM2.SAMPLES_PER_FRAME / this.sampleRate);
    var elapsedTime = Now() - startTime;
    if (this.onDecodeCallback) {
      this.onDecodeCallback(this, elapsedTime);
    }
...
var WebGLRenderer = function() {
  ...
  _proto.initGL = function initGL() {
    ...
    this.program = this.createProgram(WebGLRenderer2.SHADER.VERTEX_IDENTITY, WebGLRenderer2.SHADER.FRAGMENT_YCRCB_TO_RGBA);
    ...
    this.loadingProgram = this.createProgram(WebGLRenderer2.SHADER.VERTEX_IDENTITY, WebGLRenderer2.SHADER.FRAGMENT_LOADING);
  ...
  WebGLRenderer2.IsSupported = function IsSupported() {
    try {
...
var CanvasRenderer = function() {
  ...
  var _proto = CanvasRenderer2.prototype;
  _proto.destroy = function destroy() {
    if (this.ownsCanvasElement) {
      this.canvas.remove();
    }
...
var WebAudioOut = function() {
  function WebAudioOut2() {
    this.context = WebAudioOut2.CachedContext = WebAudioOut2.CachedContext || new (window.AudioContext || window.webkitAudioContext)();
  ...
  WebAudioOut2.NeedsUnlocking = function NeedsUnlocking() {
    return /iPhone|iPad|iPod/i.test(navigator.userAgent);
  };
  WebAudioOut2.IsSupported = function IsSupported() {
...
var WASM = function() {
  ...
  _proto.readDylinkSection = function readDylinkSection(buffer) {
    ...
    var next = 0;
    var readVarUint = function readVarUint2() {
      var ret = 0;
      var mul = 1;
      while (1) {
        var byte = bytes[next++];
    ...
    var matchNextBytes = function matchNextBytes2(expected) {
  ...
  WASM2.IsSupported = function IsSupported() {
    return !!window.WebAssembly;
  };
  WASM2.GetModule = function GetModule() {
    WASM2.CACHED_MODULE = WASM2.CACHED_MODULE || new WASM2();
    return WASM2.CACHED_MODULE;
  };
  return WASM2;
}();
...
var Player = function() {
  function Player2(url, options, hooks) {
    var _this = this;
    if (options === void 0) {
      options = {};
    }
...
var FetchSource = function() {
  function FetchSource2(url, options) {
    this.url = url;
    this.destination = null;
    this.request = null;
    this.streaming = true;
  ...
  var _proto = FetchSource2.prototype;
  _proto.connect = function connect(destination) {
    this.destination = destination;
  };
  _proto.start = function start() {
...
//# sourceMappingURL=@cycjimmy_jsmpeg-player.js.map
